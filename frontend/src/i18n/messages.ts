...
export const messages: Record<Locale, Record<MessageKey, string>> = {
  fr: {
    ...
    "nav.renameCheck": "Renommer",
    "nav.renamePrompt": "Nouveau titre",
  ...
  en: {
    ...
    "nav.renameCheck": "Rename",
    "nav.renamePrompt": "New title",
  ...
  sw: {
    ...
    "nav.renameCheck": "Badilisha jina",
    "nav.renamePrompt": "Jina jipya",
  ...
  ln: {
    ...
    "nav.renameCheck": "Kobongola nkombo",
    "nav.renamePrompt": "Nkombo ya sika",
    "nav.moreOptions": "Makambo mosusu",
  ...
  lua: {
    ...
    "nav.renameCheck": "Kubadila dina",
    "nav.renamePrompt": "Dina dia bipya",
    "nav.moreOptions": "Bintu bia nkaka",
  ...
  kg: {
    ...
    "nav.renameCheck": "Sobula nkumbu",
    "nav.renamePrompt": "Nkumbu ya mpa",
    "nav.moreOptions": "Mambu ya nkaka",
    "header.searchPlaceholder": "Luka...",
    "header.notifications": "Basango",
  ...
  rw: {
    ...
    "nav.renameCheck": "Hindura izina",
    "nav.renamePrompt": "Izina rishya",
    "nav.moreOptions": "Ibindi",
  ...
  nnb: {
    ...
    "nav.renameCheck": "Hindura erinya",
    "nav.renamePrompt": "Erinya ehyahya",
    "nav.moreOptions": "Ebindi",
